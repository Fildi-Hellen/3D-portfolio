...
let projects = [
  {
    ...
    url: 'https://fildi-hellen.github.io/weatherapp/',
  },
  {
  ...
  {
    image: 'textures/project4.PNG',
    url: 'https://github.com/Fildi-Hellen/SocialMedia-CodeAlpha',
  },
  {
    image: 'textures/mapersive.PNG',
    url: 'https://mapersive.com/',
  },
];
let aboutCameraPos = {
  x: 0.12,
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('FILDI HELLEN', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
